...
pub fn bubble_sort<T: Copy + cmp::PartialOrd>(nums: &mut Vec<T>) {
  if nums.is_empty() {
    return;
  }
...
pub fn selection_sort<T: cmp::PartialOrd>(nums: &mut Vec<T>) {
  if nums.is_empty() {
    return;
  }
...
pub fn heap_sort<T: cmp::PartialOrd>(nums: &mut Vec<T>) {
  build_heap(nums);
...
pub fn merge_sort<T: Copy + cmp::PartialOrd>(nums: &mut Vec<T>) {
  if nums.is_empty() {
    return;
  }
...
pub fn quick_sort<T: cmp::PartialOrd>(nums: &mut Vec<T>) {
  if nums.is_empty() {
    return;
  }
